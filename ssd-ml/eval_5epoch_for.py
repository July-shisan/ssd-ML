...
parser.add_argument('--trained_model',
                    default='weights/ssd300_COCO_90000.pth', type=str,
...
parser.add_argument('--imagesetfile',
                    default=osp.join(VOC_ROOT, 'ImageSets', 'Main', "test.txt"), type=str,
...
def parse_rec(filename):
    ...
    img_fold_name = 'JPEGImages'
    imagename0 = filename.replace('Annotations', img_fold_name)
...
#     global args
#     args.trained_model = "weights/ssd300_COCO_1500.pth".format(EPOCH)
#     saver_root = '/eval'
