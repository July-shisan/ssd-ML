...
parser.add_argument('--predicted_file', default='eval/results/', type=str, help='Checkpoint state_dict file for transfer learning')
args = parser.parse_args()

annopath = os.path.join('data/VOCdevkit/Annotations', '%s.xml')#测试集标注文件路径
test_imagesetfile = 'data/VOCdevkit/ImageSets/Main/test.txt'#测试集里面的图片名
...
def parse_rec(filename):
    ...
    imagename0 = filename.replace('Annotations', 'JPEGImages')
